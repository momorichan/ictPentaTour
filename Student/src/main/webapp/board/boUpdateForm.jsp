	...
	<div class="container">
		...
		<form action="<%=withFormTag%>" method="post">
			...
			<div class="input-group">
				...
				<input id="subject" name="subject" type="text" class="form-control" value="${bean.subject}">
			</div>
			<div class="input-group">
				<span class="input-group-text col-md-2">글내용</span> 
				<input id="content" name="content" type="text" class="form-control" value="${bean.content}">
			</div>  
			<div class="input-group">
			...
			<div class="input-group">
				...
				<input id="regdate" name="regdate" type="datetime" class="form-control" value="${bean.regdate}">
			</div>
