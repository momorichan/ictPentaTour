...
<head>
	...
	<script>
		/* const 키워드는 읽기 전용 */
		const maxPurchaseSize = ${bean.stock}; /* 최대 구매 가능 개수 */
		...
		$(document).ready(function(){
			...
			$('#totalprice').text('0');
			/* attr() 함수는 속성(attribute)을 읽거나 쓰기위한 함수 */
				...
				<tr>
					<td class="col-lg-5">
						<div class="card picZoomer">
							<img alt="${bean.name}" src="./../image/${bean.image01}"
								class="card-img-top active_image" width="480" height="360">
						</div>
					</td>
					<td class="col-lg-1"><img alt="${bean.name}"
						src="./../image/${bean.image01}"
						class="card-img-top small_image rounded" width="180" height="180">
					...
					<td class="col-lg-6">
						<div class="card leftside card_borderless" style="width: 18rem;">
							...
							<p class="card-text">재고 : ${bean.stock}개</p>
							<p class="card-text">
								합계 : <span id="totalprice">${bean.price}</span> 원
							</p>
						<ul class="pagination">
