				...
				<tr>
					<td class="col-lg-5">
						<div class="card picZoomer">
							<img alt="그림1" src="./../image/images/americano02.png"
								class="card-img-top active_image" width="480" height="360">
						</div>
					</td>
					<td class="col-lg-1"><img alt="그림01"
						src="./../image/images/americano02.png"
						class="card-img-top small_image rounded" width="180" height="180">
						<img alt="그림02" src="./../image/images/americano03.png"
						class="card-img-top small_image rounded" width="180" height="180">
						<img alt="그림03" src="./../image/images/cappuccino01.png"
						class="card-img-top small_image rounded" width="180" height="180">
					</td>
					<td class="col-lg-6">
